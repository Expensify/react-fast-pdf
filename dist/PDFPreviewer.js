...
function PDFPreviewer({ pageMaxWidth, isSmallScreen, file, containerStyle }) {
    ...
    const setContainerDimensions = useCallback(() => {
        ...
        setContainerWidth((_d = (_c = containerRef.current) === null || _c === void 0 ? void 0 : _c.clientHeight) !== null && _d !== void 0 ? _d : 0);
        setContainerHeight((_f = (_e = containerRef.current) === null || _e === void 0 ? void 0 : _e.clientWidth) !== null && _f !== void 0 ? _f : 0);
    ...
    return (React.createElement("div", { ref: containerRef, style: Object.assign(styles.container, containerStyle) },
